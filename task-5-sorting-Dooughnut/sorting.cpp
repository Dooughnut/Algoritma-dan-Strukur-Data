...
string name = "AfrianPradiptaRizky",
id = "2410817210028";
...
void merge(string &str, int left, int mid, int right) {
    ...
    char *tempL = new char[n1]; char *tempR = new char[n2];
    ...
    do {
        ...
        switch(ch) {
            ...
            case 7: 
                ...
                cout << "This Program Was Made by Afrian Pradipta Rizky (2410817210028)" << endl; 
                break;
            default: 
